...
public final class DateTools {
	...
	/**
	 * Transform une date en string en java.util.Date. Le format de la string
	 * est donné par un DateFormat (on peut utiliser un des DateFormat
	 * de cette classe)
	 * @param df
	 * @param date
	 * @return La date, ou si une erreur de parse arrive, renvoi la date courante
	 * @author jemore
	 */
	public static final Date dateStringToDate(DateFormat df, String date)
	{
		try
		{
